...
solc --overwrite --abi --bin-runtime -o  "${DOCKERFOLDER}/geth/deployed_contract/" $SCTEMPLATE
BINDATA=`cat ${DOCKERFOLDER}/geth/deployed_contract/HelloNeighbor.bin-runtime`
# echo $BINDATA
