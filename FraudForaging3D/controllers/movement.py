...
# from controllers.kalmafilter import KalmanFilter
import random
rays_file = 'rays.txt'
...
class NoisyOdometry(object):
    """ Set up a Navigation loop on a background thread
    The __navigating() method will be started and it will run in the background
    until the application exits.
    """

    def __init__(self, robot, std):
        """ Constructor
        :type range: int
        :param std: std of blank noice on the position coordinates
        """
